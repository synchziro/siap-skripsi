				...
				<div class="col-md-12 col-md-offset-0 text-center mt-text animate-box" data-animate-effect="fadeInUp">
						...
						<table class="col-md-12 text-center" border=2 >
							...
							<tr class="text-left">
								...
								<td class="text-center"><font color="#fff"><?php echo $data[2]; ?></font></td>
								<td style="text-align: center;width: 10%;">
          							<?php
              							if ($data[3]==1) {
              							echo "<a onclick='return konfirmasikan()' href='renew.php?id=".$data[0]."'><span class='label label-success'>Pilih</span></a>";
             							} elseif ($data[3]==2) {
